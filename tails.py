...
def plot(rgr, anal_rgr):
    ...
    ax2.semilogy(rmse_x, stoc_rmses, "^-.", label="stochastic RMSE")
    ax2.plot(rmse_x, anal_rmses, "^-.", label="analytical RMSE")
...
rgr = perform_regression(14, 100, lambda : np.random.normal(mu, sigma))
plot(rgr, anal_rgr)
